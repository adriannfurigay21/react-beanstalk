	...
	// Edit Product
		...
		*/
		...
		const addProduct = (e) => {
			...
			fetch('https://murmuring-meadow-05679.herokuapp.com/api/products/addProduct', {
				method: 'POST',
				headers: {
		...
		const editProduct = (e, productId) => {
			...
			fetch(`https://murmuring-meadow-05679.herokuapp.com/api/products/${productId}/updateProduct`, {
				method: 'PUT',
				headers: {
					'Content-Type': 'application/json',
					Authorization: `Bearer ${ localStorage.getItem('token') }`
		...
		useEffect(() => {
			...
			const archiveToggle = (productId, isActive) => {
				...
				fetch(`https://murmuring-meadow-05679.herokuapp.com/api/products/${productId}/archive`, {
					method: 'PUT',
					headers: {
						"Content-Type": "application/json",
						Authorization: `Bearer ${ localStorage.getItem('token') }`
